...
async function loadKline(code){
  ...
  try{
    ...
    const arr=await jsonp('https://quotes.sina.cn/cn/api/json_v2.php/CN_MarketDataService.getKLineData?symbol='+sym+code+'&scale=240&ma=no&datalen=140&callback='+cb, cb, 4000);
    if(arr&&arr.length){
