...
async function loadPool(mode){
  ...
  for(let page=1;page<=maxPages;page++){
    const base='https://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/Market_Center.getHQNodeData?page='+page+'&num='+num+'&sort=trade&asc=1&node=hs_a&symbol=&_s_r_a=page';
    let arr=null;
    try{
